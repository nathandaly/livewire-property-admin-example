                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('pages.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="page_title" id="pageTitle" class="form-control" value="{{ old('page_title') }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="pageContent" class="form-control" name="page_content" rows="20">{{ old('page_content') }}</textarea>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="show_on_sitemap" value="1" id="sitemap">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_page_title" id="metaPageTitle" class="form-control" value="{{ old('meta_page_title') }}">
                            </div>
                            <div class="form-group">
                                <label for="metaPageDescription">SEO Page Description</label>
                                <textarea name="meta_page_description" id="metaPageDescription" cols="30" rows="3" class="form-control">{{ old('meta_page_description') }}</textarea>
                            </div>
